# Obojima Faction Reference

17 active factions. Each has Traits, Agents, typed Advantages, a progressive Agenda, an Obstacle, and a Want.
Faction Wants and Advantages form an interconnected tension web — faction A often wants what faction B has.
Framework adapted from Cairn 2e Setting Seeds, kept narrative.
...
```
Mariners' Guild ←→ Lionfish King       (blood feud; Stabilizer vs submarine)
Fish Head Coven ←→ All covens          (Almanac volume rivalry)
AHA ←→ Lionfish King                   (Royal Lineages decryption dilemma)
Rangers ←→ Courier Brigade             (eastern Corruption front, mutual need)
Lom & Salt ←→ AHA                      (metallurgy knowledge trade)
Dawn Blossom ←→ Fish Head ←→ Lionfish  (economic dependency chain)
Goro Goros ←→ Canden & Moon            (street vs establishment in Yatamon)
Council of Kroo ←→ Fish Head Coven     (Crawling Canopy territorial secrets)
Flying Phin ←→ AHA                     (First Age flight tech exchange)
Tellu & Scale ←→ Fish Head Coven       (Lilywin ruins access)
Crowsworn ←→ Mariners' Guild           (Corruption cure research)
Toraf & Boulder ←→ Courier Brigade     (reinforcement requests)
Cloud Cap ←→ Lom & Salt                (Mount Arbora territorial)
Lionfish King ←→ Venomous Rex          (deep-sea encroachment, eastern Corruption pressure)
Deep Current ←→ AHA                    (Krocius secretly steering digs toward Oghmai's prison)
Deep Current ←→ Cloud Cap Coven        (mountain access conflict — Cloud Cap unknowingly guards the prison)
Deep Current ←→ Council of Kroo        (floppy disk calculations may relate to the seal)
```
...
- **Type:** Undersea explorers guild
- **HQ:** Four lodges at cardinal points (northern & southern active)
- **Leaders:** Captain Clintock (founder), Holly Clintock (north), Paloma Clintock (south)
- **Region:** Island-wide
- **Traits:** Tenacious, Resourceful

### Agents
- **Captain Clintock** — Guild founder. Man of few words but commanding presence. Insatiably curious, driven, introspective. Wears a uniform tailored to match a ship captain from his favorite First Age action figure series. Currently at the southern lodge researching Corruption samples. Loves his daughters more than anything except the sea.
- **Holly Clintock** — Captain's younger daughter. Gifted engineer and shipwright, runs the northern lodge at Pelican's Nest Lighthouse. Optimistic, sense of wonder, prefers workshop work to people. Always has useful tools hanging from her belt, talks to them like old friends. Designed the current Pointue and diving suits. Currently building hull patch for the sub and designing a new ship called the Windward. Lionfish King's #1 target.
- **Paloma Clintock** — Captain's eldest daughter, caretaker of southern lodge. Fearless bordering on reckless. Values lodge members as closer than family. Built her own catamaran the Shrike, wears a magical cloak of mist. Launching solo raids into Lionfish King's domain. Secret: recently infected with Corruption from a fish folk dart — hasn't told anyone.
- **Marcel** — Lighthouse keeper at Pelican's Nest. Broad-shouldered, tall, thick mustache, blind. Navigates using Holly's modified First Age fish finder (sonar rig). Tattooed arms depicting mythical marine life. Accompanied by a pelican spirit named Disaster. Mutual familial bond with Holly though neither admits it.
- **Figby** — Nakudama naturalist, musician, chef, and freediver extraordinaire. Boisterous, quick to laugh. "The glue that keeps the lodge together." Morning dives for fish, cooks meals, plays accordion. Discovered that the spirit Ogo Mo Vogo will transport trusted people to the seafloor. Currently tracking a rare "strobe fish."
- **Leobini** — Ancient navigator, Captain's closest friend. Moves with the help of a crab-like spirit named Mr. Tamlin who carries him on its back. Has a thousand stories about sea monsters, brave sailors, and foolish captains. Lived at the lodge longer than anyone.
- **Dahlia** — Elf apprentice diver. Orphaned (father died on Land of Hot Water excursion, mother died months prior). Bookworm who investigates First Age objects from the Shallows. Owns the island's largest action figure collection. Assisting Captain Clintock with Corruption research.

### Advantages
| Type | Detail |
|------|--------|
| Apparatus | The Pointue submarine (damaged, in drydock at southern lodge) |
| Specialization | Diving suits, fish finder/sonar tech, deep-water expertise |
| Information | Corruption research samples and underwater survey data |
| Position | Four lodges at compass points give island-wide coastal presence |
| Resources | Salvaged First Age navigation beacons still pulsing with magic |

### Agenda
1. Gather enough Corruption samples from the Shallows to identify the source
2. Convince AHA to share First Age submarine schematics for repair
3. Repair the Pointue's hull and navigation systems
...
- **Leader:** The Lionfish King
- **Region:** Western Shallows (offshore)
- **Traits:** Grandiose, Vain

### Agents
- **The Lionfish King** — Fish folk. Self-proclaimed monarch of the Western Shallows. Pompous, moody, vain, egotistical — but not a psychopath. Can be reasoned with if skewed in his favor. Rules by bullying and guile, no qualms about breaking his word. Fearful of the Corruption encroaching on his reef. Ultimate goal: marry a descendant of nakudama queen Okumi for true royal status. Bristling mane of spines betrays his mood.
- **Sleethar** — Moray eel royal consigliere and ocean mage. Fears his lord, under constant pressure to crack the Royal Lineages. Cowardly but shrewd and cunning — knows how to placate and manipulate the King. One slip and his head joins the others who toyed too carelessly with the monarch. Could be an ally if approached carefully.
- **Bloodfin the Foul** — Exiled female fish folk captain, leads a pirate band from a sunken First Age town (old Goodie Mart as her lair). Desperately wants back into the King's good graces. Being manipulated by sea hag Slurpgill who wants to turn her into a hag. A wild card — could rejoin the King or defect to Venomous Rex.
- **Borisss** — Sea snake spirit, fiercely loyal to Bloodfin. Coiled around a teddy bear he found when the gang first arrived. Found in Bloodfin's sunken town.
- **Morris** — Giant seahorse spirit. Cowardly, intimidated into serving Bloodfin. Terrified of Slurpgill. Will lie to or tattle on outsiders to survive. Hangs out in Moxy's Music Grotto (sunken First Age music store).
- **Lucinda** — Awakened giant octopus, gentle creature. Bloodfin holds her eggs hostage in a giant clam, forcing Lucinda to act as junkyard dog. Fears both Bloodfin and Slurpgill. A rescue target.
- **Slurpgill** — Sea hag, not technically a subject but a shadow power over Bloodfin's exile band. Wants to build a coven by turning Bloodfin into a hag. All water spirits tremble at her name. Lair location unknown. Designed as a recurring underwater nemesis.

### Advantages
| Type | Detail |
|------|--------|
| Force | Elite crab sentinels, barracuda warriors, fish folk pirates |
| Apparatus | The Doomspine war barge (with Aquatic Stabilizer in stolen Pointue prow — Stabilizer created by Clintock's late wife Kara) |
| Position | Coral Castle underwater fortress |
| Information | The Royal Lineages — 2 ancient tomes tracking nakudama royal bloodline |
| Resources | The crimson octopus "Boombox" (produces priceless magical ink) |
| Renown | Self-proclaimed king of the Shallows, feared by coastal settlements |

### Agenda
1. Hire surface-dweller mercenaries to assassinate Holly Clintock — she's the only one who can repair the Pointue. Kill the engineer, kill the submarine forever.
2. Decipher the Royal Lineages to identify a living nakudama royal heir
3. Locate the heir and arrange a marriage alliance (willing or not)
4. Hold a coronation ceremony legitimizing his rule in the spirit realm
...
### Tension
Has what Mariners' Guild desperately needs (Stabilizer). Needs what AHA has (translation). Dawn Blossom Guild needs his octopus ink for currency. Venomous Rex's deep-sea raiders pressure him from the east. Some vassals are secretly friendly to Clintock's daughters and open to cooperation against the Corruption. Multiple leverage points for player manipulation.
...
- **Type:** Academic guild
- **HQ:** Observatory on a promontory overlooking the ocean, southeastern Coastal Highlands
- **Leaders:** The Asloh — Gurriko (nakudama archaeologist, ancient building techniques), Loninni (human historian, Mount Arbora foothills), Uba (towering blue dara, chief archivist)
- **Region:** Island-wide (dozen+ field sites), HQ in southeastern Coastal Highlands
- **Traits:** Curious, Cautious

### Agents
- **Uba** — Chief Archivist (male blue dara). Stays at HQ overseeing the Archive. Not miserly — happy to share with genuinely interested visitors. Teacher mentality, believes everyone can contribute worthy ideas. Carries a secret shame: once let a charlatan scholar steal a tome detailing Mount Arbora cave networks.
- **Lonzo** — Telescope Operator (male human). Grizzled, grumbly, voice like gravel. Oldest AHA member. Spends time alone at the HQ telescope, nodding off occasionally as he charts stars. A First Age radio he keeps emits white noise interrupted by mysterious snippets in a garbled language he claims are "dispatches about some war."
- **Chloe** — Archaeologist (female elf). Wizard obsessed with First Age technology. Found in her workshop among partially assembled devices, scattered tools, and half a dozen companion spirits. Specialty: cassette players. Avid collector of First Age music — the louder, the better.
- **Vutochi** — Corruption Researcher (cat spirit). Foremost expert on the Corruption. Dispassionate air, appears disengaged or enters trances. Exists in both the Physical Realm and Spirit Realm simultaneously, shifting attention between planes. In the Spirit Realm, transforms into a tall imposing mage. Searches the eastern coastline and Brackwater for fish that escaped skeletonization.
- **Mortimus Fids** — Head Curator of the Yatamon library outpost (male human). About twenty AHA members work at this First Age library. Mortimus rules with self-importance and snobbery that makes everyone loathe him. Will make adventurers grovel, ego-stroke, and jump through hoops before sharing information.
- **Dr. Zalia Frond** — Archaeologist (female human). Leads the ongoing underground excavation beneath Yatamon's undercity. Affable, enthusiastic. Partnered with Krocius.
- **Krocius** — Claimed Second Age scholar (male nakudama). Reserved, soft-spoken, lets Dr. Frond do the talking. Secretly using Frond and AHA to delve into dangerous areas searching for the lost prison of ancient nakudama emperor Oghmai.
- **Isabel Skiff** — Field researcher (female human). High-society AHA member stationed at Toggle. Hunting for a rare gemstone called a dragon's fist. Well-funded, dapper clothes, sticks out among miners — but earnest about rolling up her sleeves.
- **Dini** — Field researcher (nakudama). Leads expeditions to Shoom, an abandoned Nakudama Age site.

### Advantages
| Type | Detail |
|------|--------|
| Information | Largest First Age tech archive — computers, floppy disks, arcade cabinets (Detective Werewolf Saga), radios, VHS tapes, cassette players |
| Specialization | Translation expertise for First Age languages and codes; deciphered much of First Age language |
| Members | Field research teams at dozen+ excavation sites; ~20 staff at Yatamon library outpost; chronicler spirits (dozen robed spirits that take dictation on scroll strips) |
| Position | 19-level observatory HQ with telescope, labs, archive, curio museum; Yatamon library outpost (First Age library) |
| Resources | First Age canned food stockpile, preserved artifacts, refurbished telescope tracking stars and flying beasts |
| Vulnerability | Flooded lowest levels secretly occupied by corrupted viperfish folk loyal to Venomous Rex, seeking entry into HQ |

### Agenda
1. Explore the ancient subway tunnels beneath Yatamon — Dr. Frond's dig is pushing deeper into the undercity, mapping collapsed passages and First Age infrastructure
2. Discover where the Wandering Line goes and what its depot network connects to — the subway system may have once linked terminals across the island
3. Research the Corruption — housing infected rangers in HQ labs, studying skeletonized fish in aquariums, losing researchers to exposure. Theories: it may be seeping into groundwater, may respond as one organism, may be hunting the island's spirit life force
4. Investigate the stellar anomaly — constellations have shifted, star movements are slowing. Debate: are the sky spirits calming, or has the island itself stopped drifting?
5. Gain access to underwater ruins via Mariners' Guild submarine
...
### Tension
Natural partnership with Mariners' Guild but competing priorities. Could be kingmaker in the Lionfish King conflict — whoever they help wins. Phin was once AHA, wants to keep airfield tech to himself. Lom & Salt want metallurgy manuals from the archive. Krocius is secretly using Frond's dig to hunt for the Prison of Oghmai — AHA doesn't know their own researcher has a hidden agenda. Viperfish folk have infiltrated the flooded HQ basement.
...
2. Acquire working First Age vehicles for faster dangerous-zone delivery
3. Establish a fortified relay station in the Brackwater Wetlands
...
- **Type:** Currency minting / economic guild
- **Leaders:** Secretive sages (identities hidden)
- **Region:** Island-wide influence
- **Traits:** Calculating, Neutral

### Agents
- **The Assessor** — Masked figure who appears at markets to evaluate currency circulation. No one knows their real identity. Speaks formally, never makes small talk, carries a First Age coin-pressing stamp.
- **Mint-Keeper Pollu** — Oversees a hidden minting facility. Friendly with merchants, trades gossip for ingredient leads. Only person who openly admits working for Dawn Blossom.

### Advantages
| Type | Detail |
|------|--------|
| Wealth | Sole authority to mint Gold Flowers, Sea Petals, and Copper Buds |
| Apparatus | First Age coin-pressing machinery enchanted with spirit magic |
| Resources | Vault of pure spirit essence used in minting enchantments |
| Anonymity | Leadership identities hidden — can't be pressured politically |
| Position | Control the entire island's economy through currency supply |

### Agenda
1. Secure a reliable supply of crimson octopus ink from Lionfish King's octopus
2. Acquire rare ingredients from Fish Head Coven for new coin enchantment batches
3. Collect working First Age vending machines to expand coin distribution
4. Maintain currency stability despite Corruption disrupting eastern trade
5. Prevent any faction from gaining enough power to threaten the monetary system
...
### Want
Reliable octopus ink supply (Lionfish King). Coven ingredients (Fish Head). First Age vending machines (scattered across island). Will pay well and stay neutral in conflicts — unless the money is threatened.

### Tension
The invisible hand. Every faction needs their currency. They maintain strict neutrality but could tip any conflict by withholding or flooding coin supply. Someone is counterfeiting, and they want it stopped.
...
- **Base:** Yatamon City
- **Leaders:** Tatsu (gang leader), Mikiko (witch apprentice)
- **Region:** Gift of Shuritashi
- **Traits:** Defiant, Creative

### Agents
- **Tatsu** — Gang leader. Charismatic troublemaker with a genuine grudge against Yatamon's elite. Tags buildings with elaborate magical graffiti that tells stories. Found in the underground tunnels or on rooftops.
- **Mikiko** — Witch apprentice who creates the magic ink. Secretly a Fish Head Coven trainee — the coven doesn't know she's sharing magic with street kids. Torn between loyalty to the gang and fear of coven punishment.

### Advantages
| Type | Detail |
|------|--------|
| Magic | Magical graffiti ink (Mikiko's creation — tags that move, whisper, and resist removal) |
| Information | Intimate knowledge of Yatamon's underground First Age subway tunnels |
| Apparatus | Stash of First Age spray paint cans that amplify magical ink effects |
| Subterfuge | Street-level eyes and ears across Yatamon's markets and alleys |
| Popularity | Folk heroes among Yatamon's working class |

### Agenda
1. Tag every Canden & Moon building with moving graffiti — public humiliation campaign
2. Acquire a cassette tape ward spell from Fish Head Coven to protect their tunnels
3. Discover what's at the end of the sealed subway tunnels beneath Yatamon
4. Prove street magic is as legitimate as coven witchery
5. Be taken seriously as a real faction, not dismissed as delinquents

### Obstacle
Mikiko's double life. If Fish Head Coven discovers she's teaching magic to unlicensed street kids, they'll demand her return and possibly punish the gang. The gang's power depends entirely on her ink — without Mikiko, they're just kids with spray paint.

### Want
A cassette tape ward spell (Fish Head has them). Canden & Moon publicly embarrassed. Recognition from any adult faction that they matter.

### Tension
Mikiko's secret is a ticking bomb. Canden & Moon's Student Captain Reiko is hunting them. The sealed subway tunnels could connect to the Wandering Line — or something worse. Fish Head's Whisper (the tea vendor spy) may already suspect Mikiko.

---

## 14. Council of Kroo

- **Type:** Eccentric hermit council
- **HQ:** Tree houses in the Crawling Canopy
- **Leaders:** Edgarton Hargreaves III
- **Members:** 4 — Penelope Mibblethorpe (witch), Sheldrake Wobbledrain (warlock), Thurston Smorkwaggle
- **Region:** Gale Fields (Crawling Canopy)
- **Traits:** Eccentric, Paranoid

### Agents
- **Edgarton Hargreaves III** — Self-appointed spokesman. Wears seven hats stacked on his head. Speaks in riddles that occasionally contain genuine cosmic truths. Found at the Wicked Wizard Tavern or up a tree.
- **Thurston Smorkwaggle** — The Council's "external affairs minister." Actually just wanders the Gale Fields muttering. Accidentally gives useful directions to lost travelers. Carries a bag of floppy disks he calls "the keys."

### Advantages
| Type | Detail |
|------|--------|
| Apparatus | Working First Age chunky computer used for "cosmic calculations" |
| Information | Floppy disks that may be vault keys to something buried underground |
| Magic | Control of the Crawling Canopy's movement (they guide the mobile forest) |
| Position | The Wicked Wizard Tavern — hidden meeting place inside the Canopy |
| Anonymity | Everyone dismisses them as harmless eccentrics |

### Agenda
1. Keep the Fish Head Coven's scouts out of the Crawling Canopy
2. Complete the "cosmic calculations" on the First Age computer
3. Determine if the thing buried beneath the Canopy is actually a superweapon or just a very large machine
4. If it's dangerous, ensure it stays buried forever
5. If it's useful, figure out how to activate it without destroying the island

### Obstacle
The Fish Head Coven suspects the Canopy hides something valuable and sends regular scouting parties. The Council can move the forest to evade them, but each move disrupts the "cosmic calculations" and delays answers about what's buried below.

### Want
Fish Head Coven to leave them alone. More floppy disks (scattered across island in First Age ruins). Someone who can actually program the computer — their "calculations" are mostly trial and error.

### Tension
The Fish Head Coven's interest is intensifying. If the buried thing is real, it could be the most significant discovery since the First Age. The Council is genuinely unsure if they're protecting the island or sitting on its destruction.

---

## 15. Tellu & Scale's School of Blades

- **Type:** Nomadic sword school
- **HQ:** None — migrates along western coast
- **Leaders:** Master Tellu (nakudama), Master Scale
- **Region:** Western coast (Gift of Shuritashi)
- **Traits:** Philosophical, Restless

### Agents
- **Master Tellu** — Ancient nakudama swordmaster. Carries a First Age stopwatch with functions nobody has decoded. Speaks in koans. Trains students while walking — the school literally never stops moving.
- **Wanderer Ishi** — Former student turned recruiter. Travels ahead of the school, identifying worthy candidates and safe campgrounds. Practical, world-weary, excellent cook. Carries oral histories in her memory.

### Advantages
| Type | Detail |
|------|--------|
| Apparatus | Master Tellu's First Age stopwatch (heirloom with mysterious undecoded functions) |
| Information | Oral history of pre-First Age Obojima that no written record preserves |
| Specialization | "The Tempered Mind" — unmatched philosophical sword training |
| Beliefs | Nomadic philosophy that attracts devoted students |

### Agenda
1. Negotiate safe passage through Fish Head Coven territory in the Gale Fields
2. Reach the Lilywin ruins — Tellu believes the lost nakudama capital holds the school's founding story
3. Decode the stopwatch's hidden functions (may require AHA or Council of Kroo's computer)
4. Discover whether the school has a legitimate claim to Lilywin
5. Settle at Lilywin if the claim holds — becoming the first sword school with ancient roots

### Obstacle
Fish Head Coven controls the Gale Fields. They won't grant passage without something in return — and Tellu's nakudama heritage may give the school a legitimate claim to Lilywin that threatens Coven territorial dominance. The Coven would rather the ruins stay forgotten.

### Want
Passage through Gale Fields (Fish Head controls). Lilywin ruins access. Someone to decode the stopwatch (AHA or Council of Kroo). Their oral histories could be priceless to AHA if they ever agreed to share.
...
- **Type:** Witch coven
- **HQ:** Brackwater Wetlands
- **Region:** Brackwater Wetlands
- **Traits:** Desperate, Resourceful

### Agents
- **Crow Mother Vex** — Coven leader. Surrounded by a permanent murder of crows that serve as scouts and messengers. Gaunt, intense, hasn't slept properly in months. Found at their wetland compound or wherever the Corruption is worst.
- **Brewer Thistle** — Potion specialist experimenting with Corruption-resistance brews. Every batch is slightly different. Test subjects include herself — her left arm has a faint dark sheen she hides under long sleeves.

### Advantages
| Type | Detail |
|------|--------|
| Magic | 1 Almanac volume (Brackwater Wetlands region) |
| Specialization | Experimental Corruption-resistance potions (partially working) |
| Information | Network of crow familiars providing intelligence across eastern Obojima |
| Apparatus | First Age propane burners repurposed for rapid cauldron work |
| Alliances | Closest magical ally to Rangers of the Greenward Path |

### Agenda
1. Obtain Mariners' Guild underwater Corruption samples (different strain than land Corruption)
2. Compare land and sea Corruption to identify a common vulnerability
3. Brew a reliable Corruption-resistance potion (current success rate: ~40%)
4. Acquire Fish Head's Shallows Almanac volume for underwater ingredient knowledge
5. Deploy a mass countermeasure before the Corruption crosses the wetlands boundary

### Obstacle
Fish Head Coven has the Shallows Almanac volume describing underwater ingredients critical to the cure. They'll only trade it for the Crowsworn's own Brackwater volume — giving it up means losing their regional foraging advantage at the worst possible time.

### Want
Mariners' Guild underwater Corruption samples. Fish Head's Shallows Almanac volume. Rangers' field data on Corruption progression. Clean ingredients from uncorrupted land (getting harder to find).

### Tension
If they fall, the east's magical defense collapses. Brewer Thistle may already be partially corrupted — is her research compromised? Fish Head's demand for a volume trade feels like extortion while the world burns. The Rangers trust them completely — betraying that trust is unthinkable.

---

## 17. The Deep Current

- **Type:** Secret society (shadow faction)
- **HQ:** None — cells embedded across other factions
- **Leader:** Unknown ("the Voice" — communicates through intermediaries and dead drops)
- **Region:** Island-wide (hidden)
- **Traits:** Patient, Fanatical

### Agents
- **Krocius** — Primary operative. Male nakudama posing as a Second Age scholar inside AHA. Partnered with Dr. Frond on the Yatamon undercity excavation, steering the dig toward passages that lead deeper — toward Mount Arbora's core. Reserved, soft-spoken, lets others do the talking. AHA has no idea.
- **Morgo** — Lost operative. Sage spirit sent into the Crawling Canopy 20 years ago to find evidence of the ancient battle between the Sky King and Oghmai — specifically proof of where the demon was imprisoned. Never came back. The Deep Current doesn't know if he's dead, lost, or if the Canopy swallowed him. (He's alive, still searching, losing his mind.)
- **Ermina Flopfoot** — Unwitting asset. Crowsworn witch who has independently studied Oghmai texts. Believes a girl named Madelaine in the Brackwater suffers from the same sickness that turned Oghmai into a demon. Doesn't know the Deep Current exists, but they're watching her research closely.
- **Unknown others** — At least one operative likely embedded in Lom & Salt's school (proximity to Mount Arbora) and possibly among the Wandering Line's passengers.

### Advantages
| Type | Detail |
|------|--------|
| Subterfuge | Members hidden inside AHA and possibly other factions — no one knows the society exists |
| Information | Ancient nakudama texts describing Oghmai's imprisonment, the seal's construction, and the prison's general location (center of Mount Arbora) |
| Position | Krocius has direct access to AHA's dig and subway tunnel mapping |
| Beliefs | Conviction that Oghmai's power is the key to nakudama restoration — willing to risk everything |

### Agenda
1. Use Krocius's position in AHA to map the subway tunnels beneath Yatamon — they may connect to the Wandering Line network and ultimately to the Prison depot
2. Locate the Wandering Line depot at the Prison of Oghmai inside Mount Arbora
3. Recover or reconstruct the seal-breaking ritual from scattered nakudama texts
4. Gain access to the Prison and harness Oghmai's power — or free him outright
5. Restore nakudama to their former greatness using the demon emperor's might

### Obstacle
The Prison is inside Mount Arbora, but they can't just dig there — Cloud Cap Coven guards the mountain's sacred sites and would violently oppose intrusion. The Wandering Line is unpredictable and requires special tickets. The subway tunnels beneath Yatamon have mostly collapsed. And the seal itself was created by Shalwin's most powerful mages — breaking it may require knowledge or artifacts that no longer exist.

### Want
AHA's subway tunnel maps (Krocius is working on it). Wandering Line access and schedule knowledge. Cloud Cap Coven's mountain spirit pathway maps. The Council of Kroo's floppy disks — their "cosmic calculations" may relate to the prison's seal. Ermina Flopfoot's Oghmai research.

### Tension
If AHA discovers Krocius's true purpose, the entire operation collapses. Cloud Cap Coven would declare war on anyone digging into the mountain. The Council of Kroo may be sitting on top of something related — their buried "superweapon or very large machine" could be connected to the prison. Lom & Salt's forge expansion near the summit could accidentally breach something. And the biggest question: is the Corruption itself connected to Oghmai's imprisonment? Is freeing him the cure — or the catastrophe?

---

## The Corruption Axis

The spreading Corruption is the meta-threat that could force rivals to cooperate — or tear alliances apart.

| Stance | Factions |
|--------|----------|
| **Fighting it** | Mariners' Guild, Rangers, Crowsworn, Toraf & Boulder |
| **Studying it** | AHA, Cloud Cap Coven |
| **Ignoring it** | Fish Head Coven, Lionfish King, Dawn Blossom, Canden & Moon |
| **Profiting from it** | Dawn Blossom (economic disruption = currency demand) |
| **Exploiting it?** | The Deep Current (believes Oghmai's power could cure — or caused — it) |

---

## First Age Tech Distribution

| Faction | Key First Age Tech |
|---------|-------------------|
| AHA | Computers, floppy disks, arcade cabinets, radios, VHS, canned food |
| Flying Phin | Biplanes, air traffic control, weather instruments, flight jackets, MREs |
| Mariners' Guild | Submarine, diving suits, fish finder/sonar, navigation beacons |
| Lionfish King | Aquatic Stabilizer (gyroscope), salvaged sub parts, submersible hatches |
| Fish Head Coven | Cassette tape spell scrolls, cassette players |
| Council of Kroo | Chunky computer, floppy disk vault keys |
| Goro Goros | Spray paint cans (magic-amplifying), subway tunnel knowledge |
| Tellu & Scale | Stopwatch with hidden functions |
| Lom & Salt | Guardian Sphere fragments |
| Canden & Moon | Vinyl record collection |
| Dawn Blossom | Coin-pressing machinery, vending machines |
| Courier Brigade | Bank vault (HQ), seeking motorcycles/kei trucks |
| Toraf & Boulder | Salvaged garage tools (wrenches, jacks, ratchets) |
| Crowsworn | Propane burners |
| Cloud Cap | Seeking radio |
| Goro Goros | Subway system maps |
| Deep Current | Ancient nakudama texts on Oghmai's seal; leveraging AHA's subway tunnel data |
...
| Category | Count |
|----------|-------|
| Major guilds | 5 (Mariners', AHA, Courier Brigade, Dawn Blossom, Flying Phin) |
| Witch covens | 3 (Fish Head, Cloud Cap, Crowsworn) |
| Sword schools | 4 (Canden & Moon, Lom & Salt, Tellu & Scale, Toraf & Boulder) |
| Regional orgs | 1 (Rangers of the Greenward Path) |
| Antagonists | 1 (Lionfish King) |
| Shadow factions | 1 (The Deep Current) |
| Other | 1 (Council of Kroo) |
| Street-level | 1 (Goro Goros) |
| **Active factions** | **17** |

*Inactive/minor: Society of Young Stewards, Patchwork Robe Coven, Tall Hats, League of the Gilded Gourd, Venomous Rex, Matango mushroom clans, and elder spirits exist in the world but aren't tracked with full Agenda mechanics.*
