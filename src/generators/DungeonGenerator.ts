...
// Note: Traps are now generated by TrapGenerator with Cairn-style mechanics
// (warning signs, tells, disarm methods). See dungeon/TrapGenerator.ts
...
/**
 * Add features and secrets to a spatial room.
 * Note: Hazards/traps are added by TrapGenerator.placeTraps() for Cairn-style traps.
 */
function addRoomContent(rng: SeededRandom, room: SpatialRoom): SpatialRoom {
  ...
  return {
    ...room,
    features,
    hazards: [], // Traps added by TrapGenerator for Cairn-style mechanics
    secrets,
  };
}
