...
const UNIVERSAL_TRAPS: TrapTemplate[] = [
  {
    ...
    warningSign: "The floor sounds hollow when tapped with a pole",
    tell: "Seams in the dust outline a rectangular section of floor",
    disarmMethods: [
      "Probe ahead with a 10-foot pole",
      "Throw heavy objects to trigger it safely",
      "Carefully peel back the covering and walk around the edge",
    ],
    targetAttribute: "STR",
  },
  {
    ...
    damage: "1d4 + poison (1d6 CON)",
    save: "DC 13 DEX to dodge",
    themes: ["*"],
    locations: ["passage"],
    warningSign: "Tiny holes line the walls at chest height",
    tell: "One floor tile is slightly raised and a different color",
    disarmMethods: [
      "Jam cloth into the dart holes",
      "Step over the pressure plate",
      "Place a heavy object on the plate and stand clear",
  ...
  },
  {
    ...
    themes: ["*"],
    locations: ["passage"],
    warningSign: "Fresh scratches on the ceiling directly above",
    tell: "A thin wire glints at ankle height across the passage",
    disarmMethods: [
      "Step carefully over the tripwire",
      "Cut the wire from a safe distance with a blade on a pole",
      "Wedge the block in place before cutting the wire",
    ],
    consequence: "The crash blocks the passage until cleared (1 hour)",
    targetAttribute: "STR",
  },
];
...
const TOMB_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    themes: ["tomb", "crypt"],
    locations: ["room"],
    warningSign: "An unnatural chill emanates from the carved floor tiles",
    tell: "Faintly glowing symbols form a circle around the sarcophagus",
    disarmMethods: [
  ...
  },
  {
    ...
    damage: "1d4 DEX + paralysis (1d4 hours)",
    save: "DC 14 DEX to withdraw hand",
    themes: ["tomb", "fortress"],
    locations: ["passage"],
    warningSign: "A faint chemical smell wafts from the keyhole",
    tell: "Dark stains discolor the stone around the lock",
    disarmMethods: [
      "Insert a thin wire to trigger the needle first",
      "Pour oil into the lock to jam the mechanism",
      "Pick the lock from an angle using thieves' tools",
  ...
  },
  {
    ...
    save: "DC 15 STR to hold walls apart",
    themes: ["tomb"],
    locations: ["room"],
    warningSign: "Bones and crushed equipment line the walls' seams",
    tell: "The walls have fresh scratches and a visible gap at the floor",
    disarmMethods: [
      "Wedge iron spikes between the wall sections",
      "Locate and jam the pressure plates with debris",
      "Move through quickly before walls gain momentum",
      "Find the hidden switch near the exit",
    ],
    consequence: "Triggers slowly - 3 rounds to escape before full crush",
    targetAttribute: "STR",
  },
];
...
const CAVE_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    damage: "2d6 STR (buried)",
    save: "DC 13 DEX to dive clear",
    themes: ["cave", "mine"],
    locations: ["room", "passage"],
    warningSign: "Small pebbles occasionally fall from above",
    tell: "A network of cracks spreads across the ceiling; support timbers are rotted",
    disarmMethods: [
      "Trigger the collapse from a safe distance with thrown rocks",
      "Crawl along the wall where the ceiling is more stable",
      "Shore it up with spare timber or iron spikes",
      "Move through quickly and quietly, one at a time",
    ],
    consequence: "Loud crash alerts all creatures within 200 feet",
    targetAttribute: "STR",
  },
  {
    name: "Slippery Slope",
    ...
    themes: ["cave"],
    locations: ["passage"],
    warningSign: "The sound of dripping water and a cold updraft",
    tell: "The floor gleams wetly and angles sharply downward",
    disarmMethods: [
      "Anchor a rope at the top and descend carefully",
      "Scatter sand or gravel for traction",
      "Find another route around",
      "Slide down intentionally with a light source to see the bottom",
    ],
  ...
  },
  {
    ...
    damage: "Restrained + 1d6 poison if spiders arrive",
    save: "DC 11 STR to break free",
    themes: ["cave"],
    locations: ["passage"],
    warningSign: "Silk strands drift in the air; small wrapped bundles hang nearby",
    tell: "A wall of webbing stretches floor to ceiling across the passage",
    disarmMethods: [
      "Burn the webs with a torch (alerts spiders but clears path)",
      "Cut a careful path through with a blade",
      "Find a side passage around the web",
    ],
...
const TEMPLE_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    locations: ["room"],
    warningSign: "The scent of oil and a faint warmth from the floor",
    tell: "Small holes pattern the floor in a grid; scorched bones lie nearby",
    disarmMethods: [
      "Stuff the vents with cloth or debris",
      "Time your movement between the flame bursts",
      "Douse the area with water to cool the mechanism",
      "Recite the temple's sacred words (found in the library)",
    ],
    consequence: "The flames illuminate the room brightly for 1 minute",
    targetAttribute: "DEX",
  },
  {
    name: "Guardian Idol",
    ...
    themes: ["temple"],
    locations: ["passage"],
    warningSign: "The statue's eyes are inset with crystals that catch the light",
    tell: "Other statues along the hall have been defaced or toppled",
    disarmMethods: [
      "Cover or destroy the crystal eyes",
      "Bow respectfully and speak a prayer",
  ...
  },
  {
    ...
    damage: "1d8 STR (blade) or 1d6 CON (gas)",
    save: "DC 13 DEX",
    themes: ["temple", "shrine"],
    locations: ["room"],
    warningSign: "The offerings look valuable but undisturbed for years",
    tell: "The plate sits on a slightly raised pedestal with visible hinges",
    disarmMethods: [
      "Replace the offering with something of equal weight",
      "Jam the mechanism with a dagger before lifting",
      "Tip the plate rather than lifting it",
...
const MINE_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    damage: "Swept away + drowning (1d6 CON per round)",
    save: "DC 12 STR to grab hold",
    themes: ["mine", "sewer"],
    locations: ["passage"],
    warningSign: "Water seeps through cracks in the wall; the air is humid",
    tell: "Fresh watermarks stain the walls at shoulder height",
    disarmMethods: [
      "Brace the weakened section before passing",
      "Drain the water by breaking through a lower tunnel",
      "Swim through quickly with a rope tied to the group",
      "Find an alternate route through upper tunnels",
    ],
    consequence: "Tunnel floods to waist height; slows movement",
    targetAttribute: "CON",
  },
  {
    ...
    themes: ["mine"],
    locations: ["room"],
    warningSign: "A faint, sweet smell; the air feels thick",
    tell: "Canaries or other small animals lie dead; torches flicker oddly",
    disarmMethods: [
      "Extinguish all flames before entering",
      "Use a hooded lantern with the vent closed",
      "Ventilate the area by opening a shaft or passage",
      "Cast Light instead of using fire",
    ],
    consequence: "Collapse risk if explosion occurs; may trap party",
    targetAttribute: "STR",
  },
  {
    ...
    themes: ["mine"],
    locations: ["passage"],
    warningSign: "Track rails lead downward; a heavy cart sits at the top",
    tell: "The cart's brake lever is rusted through; pebbles hold it in place",
    disarmMethods: [
    ...
    consequence: "The noise echoes throughout the mine level",
    targetAttribute: "STR",
  },
];
...
const FORTRESS_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    themes: ["fortress"],
    locations: ["passage"],
    warningSign: "The passage is unusually straight and narrow",
    tell: "Small holes line the ceiling; old oil stains darken the floor",
    disarmMethods: [
      "Create a distraction while someone blocks the holes from above",
      "Sprint through in a single rush",
      "Use shields overhead as a testudo formation",
      "Find the upper chamber and neutralize defenders first",
    ],
  ...
  },
  {
    ...
    themes: ["fortress"],
    locations: ["passage"],
    warningSign: "Grooves in the walls show where something slides down",
    tell: "An iron grate is visible above, suspended by chains",
    disarmMethods: [
      "Jam the grooves with iron spikes before triggering",
      "Have someone hold the chain or counterweight",
      "Move through one at a time quickly",
      "Trigger it intentionally from the safe side",
    ],
    consequence: "Party is split; those inside face guards from both directions",
    targetAttribute: "STR",
  },
  {
    name: "Alarm Bells",
    ...
    save: "DC 10 DEX to stop the bell",
    themes: ["fortress"],
    locations: ["passage", "room"],
    warningSign: "Faint sounds of bells deeper in the fortress",
    tell: "A thin cord stretches across the doorway at ankle height",
    disarmMethods: [
      "Step over the tripwire carefully",
      "Cut the wire while holding the bell",
      "Muffle the bell with cloth before triggering",
    ],
    consequence: "All creatures in the fortress go to alert status",
    targetAttribute: "DEX",
  },
];
...
const SEWER_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    themes: ["sewer"],
    locations: ["room", "passage"],
    warningSign: "A rotten egg smell grows stronger ahead",
    tell: "Dead rats and insects litter the floor; no living things here",
    disarmMethods: [
    ...
    consequence: "Open flame causes 2d6 fire damage explosion",
    targetAttribute: "CON",
  },
  {
    name: "Waste Surge",
    ...
    themes: ["sewer"],
    locations: ["passage"],
    warningSign: "The sound of rushing water echoes from ahead",
    tell: "High watermarks on the walls; debris caught in crevices",
    disarmMethods: [
      "Wait for the surge to pass (1d6 minutes)",
      "Climb above the high watermark using spikes",
  ...
  },
  {
    ...
    themes: ["sewer"],
    locations: ["passage"],
    warningSign: "The steps glisten wetly in your torchlight",
    tell: "A greenish sheen coats every surface; handrails are rusted through",
    disarmMethods: [
      "Scatter sand or gravel for traction",
...
const CRYPT_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    themes: ["crypt"],
    locations: ["room"],
    warningSign: "An unnatural cold settles into your bones",
    tell: "Rusted chains hang from the walls; they rattle without wind",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["crypt"],
    locations: ["room", "passage"],
    warningSign: "The bones are stacked too neatly to be natural",
    tell: "A slight depression in the floor beneath the bone pile",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["crypt"],
    locations: ["room"],
    warningSign: "Thick dust coats everything; the air is still and stale",
    tell: "Disturbing anything sends up visible clouds",
    disarmMethods: [
...
const CULTIST_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    themes: ["cultist_lair"],
    locations: ["room"],
    warningSign: "A coppery smell and a sense of wrongness",
    tell: "Intricate patterns in dried brown-red cover the floor around a central symbol",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["cultist_lair"],
    locations: ["room"],
    warningSign: "Candles are arranged in a precise pattern; chalk marks the floor",
    tell: "A complete summoning circle with intact symbols and fresh wax",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["cultist_lair"],
    locations: ["room"],
    warningSign: "Your reflection seems to move slightly wrong",
    tell: "The mirror's frame is carved with screaming faces; others are covered",
    disarmMethods: [
...
const SEA_CAVE_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    themes: ["sea_cave"],
    locations: ["passage"],
    warningSign: "The sound of crashing waves grows louder; water drips from the ceiling",
    tell: "Watermarks reach near the ceiling; seaweed clings to the upper walls",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["sea_cave"],
    locations: ["passage"],
    warningSign: "The passage narrows; white crusting covers the walls",
    tell: "Old blood stains the rock; shells glint with knife-sharp edges",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["sea_cave"],
    locations: ["room"],
    warningSign: "The water is unusually dark; you can't see the bottom",
    tell: "A current pulls gently toward the center of the pool",
    disarmMethods: [
...
const FLOATING_TRAPS: TrapTemplate[] = [
  ...UNIVERSAL_TRAPS,
  {
    ...
    locations: ["room"],
    warningSign: "Small objects float slightly; dust hangs in the air",
    tell: "Scorch marks on the ceiling where others fell upward",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["floating_keep"],
    locations: ["passage"],
    warningSign: "A howling whistle; your cloak whips violently",
    tell: "The passage ends in open sky; scratch marks show where others tried to hold on",
    disarmMethods: [
  ...
  },
  {
    ...
    themes: ["floating_keep"],
    locations: ["room"],
    warningSign: "The floor looks too clean; no dust, no footprints",
    tell: "Your shadow doesn't fall on the floor correctly",
    disarmMethods: [
